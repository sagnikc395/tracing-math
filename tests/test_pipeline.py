"""Tests for pipeline orchestration and artifact generation."""
...
from tracing_math import pipeline
from tracing_math.config import ProjectConfig
from tracing_math.pipeline import load_activation_metadata, plot_artifacts
...
def test_plot_artifacts_creates_only_essential_paper_figures(tmp_path) -> None:
    base_config = ProjectConfig.from_yaml("configs/project.yaml")
